...
namespace PG2.Shading
{
    public class Phong : Shader
    {
        ...
        public Vector3 DiffuseColor, SpecularColor, AmbientColor = Vector3.Zero;
        ...
        public override Vector3 GetColor(Vector3 point, Vector3 normal, Vector3 viewDir, Vector3 lightDir, Light light)
        {
            ...
            //double scalar= Math.Min(viewDir * reflectionVector,1); //klampovanie, aby sme nemali prepalenie - urobim to nakonci
