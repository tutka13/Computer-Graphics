...
namespace PG2.Rendering
{
    public class Camera
    {
        ...
        public void RayTrace()
        {
            ...
            U = Up % W; //Up jednotkovy, W jednotkovy => U bude jednotkovy
            V = U % W;
            ...
            for (int r = 0; r < Height; r++)
            {
                ...
                for (int c = 0; c < Width; c++)
                {
                    ...
                    Ray currentRay = new Ray(Position, vectorDirection, zNear, zFar);
        ...
        public Vector3 RayTrace(Ray ray)
        {
            ...
            //       Return hit model color if intersection exists else return background color
            World.Collide(ray);
            double attentuation = 1 - ray.HitParameter / (2 * (Target - Position)).Length;
            return attentuation * ray.HitModel.Color;
        }
